      ...
      <main className="flex-1 flex flex-col items-center pt-12 px-4 bg-gray-50/30">
        <div className="w-full max-w-2xl bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          <form onSubmit={handleSearch} className="flex flex-col gap-6">
             <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg p-4 text-lg outline-none focus:border-[#0F3460] focus:ring-1 focus:ring-[#0F3460] transition-all font-mono placeholder:text-gray-300 text-gray-900"
             ...
             <button
               type="submit"
               className="w-full bg-[#0F3460] text-white hover:bg-[#154175] px-6 py-4 rounded-lg text-base font-bold uppercase tracking-wider transition-all shadow-lg shadow-blue-900/20 active:translate-y-0.5"
             >
        ...
        <div className="w-full max-w-2xl mt-8 flex items-start gap-3 bg-blue-50/80 p-5 rounded-lg border border-blue-100 shadow-sm">
           <div className="mt-0.5 min-w-[20px]">
               <svg className="w-5 h-5 text-[#0F3460]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
               </svg>
           </div>
           <p className="text-sm font-medium text-[#0F3460] leading-relaxed">
